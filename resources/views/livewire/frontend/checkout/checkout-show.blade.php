...
@push('scripts')
<script
    src="https://www.paypal.com/sdk/js?client-id=AQi32s4HD1oewmFeSuop6NzSB13tAg8ttqJZGRyyS2TYwU5yqzYCH_AEM_7Pee7Z5IanpUcLSGJPNxca&currency=USD"></script>
    ...
    paypal.Buttons({
        ...
        onApprove: (data, actions) => {
            return actions.order.capture().then(function(orderData) {
                console.log('Capture Result', orderData, JSON.stringfy(orderData, null, 2));
